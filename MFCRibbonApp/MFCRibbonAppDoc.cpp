...
void CMFCRibbonAppDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CMFCRibbonAppDoc::InitializeSearchContent()
{
...
void CMFCRibbonAppDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
