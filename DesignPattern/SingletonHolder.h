...
////////////////////////////////////////////////////////////////////////////////
	...
	typedef void __cdecl DestroyerFunc ();

	template <class T>
	struct DefaultLifetime
	{
		static void ScheduleDestruction (T*, DestroyerFunc* pFun)
		{ 
			atexit (pFun); 
		}
...
////////////////////////////////////////////////////////////////////////////////
	...
	{
	public:
		static void ScheduleDestruction(T* pObj, DestroyerFunc* pFun)
		{
...
////////////////////////////////////////////////////////////////////////////////
	...
	struct NoDestroy
	{
		static void ScheduleDestruction(T*, DestroyerFunc*)
		{}
...
#pragma warning (pop)
	...
	<
		...
		class M
	>
	void __cdecl SingletonHolder<T, CreationPolicy, L, M>::DestroySingleton()
	{
		_ASSERT(!destroyed_);
